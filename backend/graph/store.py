...
def _get_memory_service() -> MemoryService | None:
    ...
    try:
        ...
        logger.warning("[graph.store] init memory service failed")
...
def load_memory_context(
    *,
    ...
    try:
        ...
        logger.warning("[graph.store] load profile failed")
        return {}
...
def persist_memory_snapshot(
    *,
    ...
    try:
        ...
        logger.warning("[graph.store] load profile before persist failed")
        return False
    ...
    try:
        ...
        logger.warning("[graph.store] persist profile failed")
        return False
