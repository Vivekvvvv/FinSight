...
CN_HOLIDAYS = {
    ...
    # 2026年节假日（国务院办公厅2025-11-04通知）
    date(2026, 1, 1): "元旦",
    date(2026, 1, 2): "元旦",
    date(2026, 1, 3): "元旦",
    # 春节 2/15-2/23 共9天（含除夕2/16，此前漏标2/15-2/16）
    date(2026, 2, 15): "春节",
    date(2026, 2, 16): "春节",
    date(2026, 2, 17): "春节",
    date(2026, 2, 18): "春节",
    ...
    date(2026, 9, 26): "中秋节",
    date(2026, 9, 27): "中秋节",
    # 国庆实为 10/1-10/7（旧表多标 10/8，开市日被判休市）
    date(2026, 10, 1): "国庆节",
    date(2026, 10, 2): "国庆节",
    date(2026, 10, 3): "国庆节",
    date(2026, 10, 4): "国庆节",
...
# 调休工作日（部分周末调整为工作日）
WORKDAY_OVERRIDES = {
    # 2026年调休工作日（国务院2025-11-04通知口径）
    date(2026, 2, 14): "春节前调休",   # 周六上班（旧表误写2/7）
    date(2026, 2, 28): "春节后调休",   # 周六上班
    date(2026, 9, 20): "国庆前调休",   # 周日上班（旧表误写9/27，与中秋假期冲突）
